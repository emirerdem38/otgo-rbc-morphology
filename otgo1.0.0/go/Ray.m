classdef Ray
    ...
    methods
        ...
        function [r_r,r_t,perp] = snellslaw(r,s,n1,n2,n,first)
            ...
            % 	should be used.
            %
            % See also Ray, Superficies, Plane, Spherical, Ellipsoidal, Cylindrical, RBC.
            ...
            elseif isa(s,'Superficies')
                % intersection between ray and sphere, ellipsoid, cylinder,
                % RBC, Cell
                if nargin<6
                    p = s.intersectionpoint(r,n);
                else
                    p = s.intersectionpoint(r,n,first);
                end
